...
namespace MarvelShopping.IdentityServer.Initializer
{
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            {
                UserName = "egito-admin",
                Email = "emmanuelegito@mail.com",
                EmailConfirmed = true,
                PhoneNumber = "(88)981558899",
                FirstName = "Emmanuel",
                LastName = "Admin"
            };

            _user.CreateAsync(admin, "Em1234*").GetAwaiter().GetResult();
            ...
            {
                UserName = "egito-client",
                Email = "emmanuelclient@mail.com",
                EmailConfirmed = true,
                PhoneNumber = "(88)981558899",
                FirstName = "Emmanuel",
                LastName = "Client"
            ...
            _user.CreateAsync(client, "Em1234*").GetAwaiter().GetResult();
